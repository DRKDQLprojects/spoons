...
const Setup = (props: SetupProps) => {
      ...
      elems.push(
        <div key={`lobby-${player.id}`} className={styles.player}>
          <Grid 
              ...
              gridTemplateRows=""
            >
            <Flexbox column={width > 700} noWrap={width <= 700} center={width > 700} spaceBetween={width <= 700}>
              <Flexbox>
                {player.nickname} 
              </Flexbox>
              {player.isHost && 
  ...
  return (
    ...
    <div className={styles.container} style={{ transform: `scale(${scale})`, transformOrigin: 'top'}}>
      <Grid 
        gridTemplateColumns={width > 700 ? "2fr 3fr" : ''}
        gridTemplateRows={width > 700 ? '' : '1fr 1fr'}
      > 
